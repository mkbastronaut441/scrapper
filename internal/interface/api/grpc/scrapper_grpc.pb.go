...
const (
	LoggerService_SaveLog_FullMethodName = "/LoggerService/SaveLog"
)
...
type LoggerServiceClient interface {
	SaveLog(ctx context.Context, in *LoggingReq, opts ...grpc.CallOption) (*LogRes, error)
}
...
func (c *loggerServiceClient) SaveLog(ctx context.Context, in *LoggingReq, opts ...grpc.CallOption) (*LogRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LogRes)
	err := c.cc.Invoke(ctx, LoggerService_SaveLog_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LoggerServiceServer interface {
	SaveLog(context.Context, *LoggingReq) (*LogRes, error)
...
func (UnimplementedLoggerServiceServer) SaveLog(context.Context, *LoggingReq) (*LogRes, error) {
...
func _LoggerService_SaveLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LoggingReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LoggerServiceServer).SaveLog(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LoggerService_SaveLog_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoggerServiceServer).SaveLog(ctx, req.(*LoggingReq))
	}
...
var LoggerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SaveLog",
			Handler:    _LoggerService_SaveLog_Handler,
		},
	},
